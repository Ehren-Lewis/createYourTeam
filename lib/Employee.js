...
// This code is written particulary for using es6 
// which causes an error with jest, which uses module.exports 
// Keeping the code to come back to and to figure out a way to code it in  
// es6 
